          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <button
                ...
                className="shadow-theme-xs h-11 w-full cursor-pointer rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-left text-sm text-gray-400 placeholder:text-gray-400 xl:w-[430px] dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/30"
              >
